...
-----------------------------------------------|----------------------------------------------|:------------------:|:-------------------:
[`PSAboot`](/PSAboot)                          | Bootstrapping for Propensity Score Analysis. | [![Build Status](https://travis-ci.org/jbryer/PSAboot?branch=master)](https://travis-ci.org/jbryer/PSAboot) | [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/PSAboot)](http://cran.r-project.org/package=PSAboot) 
...
[`likert`](/likert)                            | An R package to analyze and visualize Likert based items. |  | [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/likert)](http://cran.r-project.org/package=likert) 
